...
public interface DonationRepository extends CrudRepository<Donation,Long> {
    @Query("select d.id as id,d.date as date, d.amount as amount,c.name as campaign, o.name as organization, a.email as account" +
    ...
    @Query("select d.id as id,d.date as date, d.amount as amount,c.name as campaign, o.name as organization, a.email as account" +
             " from Donation d join d.account a join d.campaign c join c.organization o")
    Page<IDonationDto> getAllDonationDto(Pageable pageable);
